...
public class SayHelloToTheWorld {
  String[] hellos = {"Mirëdita", "Ahalan", "Parev", "Zdravei", "Nei Ho", "Dobrý den", "Ahoj", "Goddag", "Goede dag, Hallo", "Hello", "Saluton", "Hei", "Bonjour",
          "Guten Tag", "Gia'sou", "Aloha", "Shalom", "Namaste", "Namaste", "Jó napot", "Halló", "Szia", "Góðan daginn", "Halo", "Aksunai", "Qanuipit", "Dia dhuit",
  ...
  @RequestMapping(value = "/web/new/greeting")
